<?php
/**
 * Plugin Name: Multiple Sidebar Generator
...
class Simple_Page_Sidebars {
	...
	public static function load_textdomain() {
		$locale = apply_filters( 'plugin_locale', get_locale(), 'multiple-sidebar-generator' );
		load_textdomain( 'multiple-sidebar-generator', WP_LANG_DIR . '/multiple-sidebar-generator/' . $locale . '.mo' );
		load_plugin_textdomain( 'multiple-sidebar-generator', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
	}
	...
	/**
	 * Add custom widget areas and automatically register Simple Page Sidebars.
	 *
	...
	public static function replace_sidebar( $sidebars_widgets ) {
		...
		$supports = ( isset( $post->post_type ) && post_type_supports( $post->post_type, 'multiple-sidebar-generator' ) ) ? true : false;
